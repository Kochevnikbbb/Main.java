...
public class RPG_Game {
    ...
    public static void start() {
        ...
        Wither wither = new Wither(250, 0, "Ведьмочка");
        Avrora avrora = new Avrora(220, 15, "Трусишка");
        Druid druid = new Druid(230, 15, "Косячник");
        Antman antman = new Antman(250, 20, "Человек Муравей");
        Hero[] heroes = {warrior, doc, berserk, magic, assistant, wither, avrora, druid, antman};
